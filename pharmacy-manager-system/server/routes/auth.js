...
router.put('/update-patient', protect, isStaff, isAccountActive, authController.updatePatient) // route to update patient account
...
router.post('/logout', authController.logout) // route for user login
...
router.get('/auth-logs', protect, isAccountActive, isManager, authController.getAuthLogs) // route for getting auth logs
