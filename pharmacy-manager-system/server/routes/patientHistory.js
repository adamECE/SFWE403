...
router.put("/fill-prescription", protect, isAccountActive, isPharmacist, prescriptionController.fillPrescription, logPrescription); // route to get list of inventory
